      ...
      <div className='relative size-full'>
        ...
        <div className='relative z-10 flex size-full flex-col justify-between p-5 text-blue-50'>
            <div>
                ...
                {description && 
                    <p className='mt-3 max-w-64 text-xs md:text-base'>{description}
                    </p>
                }
            </div>
        </div>
    ...
    <section className='bg-black pb-52'>
        <div className='container mx-auto px-3 md:px-10'>
            <div className="px-5 py-32">
                ...
                <p className='max-w-md font-circular-web text-lg text-blue-50 opacity-50'>Immerse yourself in a rich and ever-expanding universe where a vibrant arrat of products converge into an interconnected overlay experience on your world.</p>
            </div>
            <BentoTilt className='border-hsla relative mb-7 h-96 w-full overflow-hidden rounded-md md:hj-[65vh]'>
                <BentoCard 
                    src={`videos/feature-1.mp4`}
                    title={<React.Fragment>radi<b>a</b>nt</React.Fragment>}
            ...
            <BentoTilt className='grid h-[135vh] grid-cols-2 grid-rows-3 gap-7'>
                <div className='bento-tilt_1 row-span-1 md:col-span-1 md:row-span-2'>
                    <BentoCard 
                        ...
                        title={<React.Fragment>zig<b>m</b>a</React.Fragment>}
                ...
                <BentoTilt className='bento-tilt_1 row-span-1 ms-32 md:col-span-1 md:ms-0'>
                    <BentoCard 
                        ...
                        title={<React.Fragment>n<b>e</b>xus</React.Fragment>}
                ...
                <BentoTilt className='bento-tilt_1 me-14 md:col-span-1 md:me-0'>
                    <BentoCard 
                        ...
                        title={<React.Fragment>az<b>u</b>l</React.Fragment>}
